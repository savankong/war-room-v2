...
-- Run through psql or any connected database client. This is a one-off cleanup
-- script, not a migration: it sits alongside migrations/legacy/ for provenance
-- but the runner ignores it, because its filename carries no version number.
