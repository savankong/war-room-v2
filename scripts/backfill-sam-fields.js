  ...
  for (const row of rows) {
    ...
    await db`
      UPDATE contracts SET
        ...
        deadline             = COALESCE(deadline, ${fields.deadline ? new Date(fields.deadline) : null}),
        published_date       = COALESCE(published_date, ${fields.published_date ? new Date(fields.published_date) : null}),
