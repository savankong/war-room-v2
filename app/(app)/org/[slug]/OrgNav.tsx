...
export default function OrgNav({ orgs, currentId, currentBranch }: {
  ...
  return (
    <>
      ...
      <button
        className={`onav-mobile-toggle${mobileOpen ? ' open' : ''}`}
        onClick={() => setMobileOpen(o => !o)}
      >
        <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
          <rect x="1" y="3" width="12" height="1.5" rx=".75" fill="currentColor"/>
          <rect x="1" y="6.5" width="8" height="1.5" rx=".75" fill="currentColor"/>
          <rect x="1" y="10" width="10" height="1.5" rx=".75" fill="currentColor"/>
        </svg>
        Browse {branch} orgs
      ...
      <nav className={`onav${mobileOpen ? ' mobile-open' : ''}`}>
